...
export default function Signup() {
    ...
    return (
        <div className="flex flex-col text-center items-center h-full">
            ...
            <span
                className={`${signupFailed ? 'text-red-500' : 'text-white'} text-sm h-fit transition duration-200 my-5`}
            >
                {signupFailedMessage}
            </span>
            ...
            <span className="text-sm text-primary/70 my-10 bottom-0 mt-auto">
                ...
                <Link href="/auth/login" className="text-primary/90 font-medium hover:underline">
                    Log in now
                </Link>
            </span>
        </div>
