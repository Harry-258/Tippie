...
import { UserPlusIcon, CrownIcon, UsersFourIcon } from '@phosphor-icons/react';
import Modal from '@/app/components/Modal';
import { useUserContext } from '@/contexts/userContext';

export default function Team() {
    const { teamName, teamId, refetch } = useUserContext();
                    ...
                    {currentTeamId && currentTeamName ? (
                        ...
                        <div className="w-full flex flex-col h-full">
                            <span className="text-xl mb-8">
                                Oops! Looks like you are not part of a team yet. Create or join a
                                team to split and compare your tips with your colleagues.
                            </span>
                            ...
                            <div className="flex flex-row gap-12 items-center justify-evenly w-full h-full">
                                <div className="flex flex-col gap-4 rounded-xl shadow-md p-8 w-1/2 border-2 border-action h-full">
                                    ...
                                    <ul className="list-disc list-inside text-lg mb-4">
                                        ...
                                        <li>
                                            See individual staff averages for ratings and
                                            performance
                                        </li>
                                    </ul>
                                ...
                                <div className="flex flex-col gap-4 rounded-xl shadow-md p-8 w-1/2 border-2 border-action h-full">
                                    ...
                                    <ul className="list-disc list-inside text-lg mb-4">
                                        <li>
                                            See your split of the total tips received by the team
                                        </li>
