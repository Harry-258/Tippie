                ...
                <div className="h-full w-full flex flex-col justify-between">
                    <div className="flex flex-col gap-4 overflow-y-auto pb-10 mt-6">
                        {currentConversation && (
                            currentConversation.messages.map((message, index: number) => (
                                <div className={`${message.sender === MessageSender.User ? "justify-end" : ""} flex w-auto`} key={index}>
                                    <div
                                        className={`p-4 mx-6 ${message.sender === MessageSender.Agent 
                                            ? "py-2" 
                    ...
                    >
                        ...
                        <div className="m-4 hover:cursor-pointer" onClick={submitMessage}>
                            <ArrowCircleUpIcon size={30} className="text-gray-400 hover:text-gray-500" weight="light"/>
                        </div>
                    </div>
                </div>
            </Tile>
